...
export const AboutText: React.FC<Props> = ({ className }) => {
  return (
    ...
    >
      <h3 className="text-xl font-medium">Get to know me!☀️</h3>
      <p>
        ...
        erat eget rutrum. Nam semper, urna sed gravida tristique, urna magna
        rutrum ligula, a ullamcorper nisl nunc nec sem. Nulla laoreet pretium
        erat dictum dignissim. Etiam nisl purus, ultricies et nunc sit amet,
        elementum ultrices nunc. Aliquam nulla urna, dignissim vel purus quis,
        hendrerit sodales augue. Vivamus id libero hendrerit, ullamcorper mauris
        id, placerat sapien.
        <br />
        <br />
